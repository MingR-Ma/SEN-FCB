...
import numpy as np
import losses
from model import Net,CompositionTransform3D as CompositionTransform,SpatialTransform3D as SpatialTransform
...
parser.add_argument('--reg_smooth', default=2, type=float)
parser.add_argument('--vol_shape', nargs='+', type=int, default=[96, 112, 96])
parser.add_argument('--data', default='./Data/data/', type=str)
parser.add_argument('--batch_size', default=1, type=int)
parser.add_argument('--checkpoints', default=5000, type=int)
